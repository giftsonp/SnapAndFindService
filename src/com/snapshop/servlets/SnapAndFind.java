...
import com.snapshop.logic.ReponseBuilder;
/**
 * Servlet implementation class SnapAndFind
 */
@WebServlet("/SnapAndFind")
public class SnapAndFind extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ReponseBuilder responseOutput = new ReponseBuilder();
		sampleResponse = responseOutput.buildMainResponse();
